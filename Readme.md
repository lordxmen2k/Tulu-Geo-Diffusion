...
| **Latent Space** | 768-Dimensional Continuous Vectors                                                 |
| **Sequence Length** | 32 Tokens                                                                       |
| **Denoising Steps** | 50-60 Steps (Linear Schedule)                                                   |
| **VRAM Profile** | ~4.2GB (Train) / ~2.1GB (Inference)                                                |
| **Guidance Scale** | 7.5 (Factual Adherence Scale)                                                    |
...
**v1.0.0**: Initial Diffusion release; focused on latent denoising.

**v1.1.0**: Optimized for factual accuracy. Implemented Positional Sequence Extraction and Logit Anchoring, successfully resolving complex multi-token names like "Brasilia" and "New Delhi."
